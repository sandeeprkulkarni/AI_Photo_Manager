# backend/modules/index_store.py
import sqlite3
    ...
    with sqlite3.connect(DB_PATH) as conn:
        conn.execute("""
                     ...
                     (
                         ...
                         REAL, -- Longitude
                         location_name
                         TEXT, -- Resolved City/Place
                         event_type
                         TEXT, -- Wedding, Festival, etc.
                         duplicate_group_id
                         TEXT, -- Tracks clustered near-duplicate photos
                         is_best_variant
                         INTEGER
                         DEFAULT
                         1     -- 1 = Best choice, 0 = Hidden duplicate duplicate
                     )""")
        ...
        conn.execute("""
                     ...
                     (
                         ...
                         identity_name TEXT, -- Explicitly trained identity
                         UNIQUE
                     (
                         photo_id,
                         rect_x,
